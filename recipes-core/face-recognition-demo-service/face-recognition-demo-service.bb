...
SRC_URI += " \
    file://face-recognition-demo.desktop \
    file://illia.jpg \
    file://vlad.jpg \
    file://yarik.jpg \
"
...
do_install() {
    ...
    install ${S}/../face-recognition-demo.desktop ${D}/home/root/.config/autostart/face-recognition-demo.desktop
...
FILES:${PN} += " \
    /home/root/face-recognition-demo/images/* \
    /home/root/.config/autostart/face-recognition-demo.desktop \
"

RDEPENDS:${PN} += " maxpower"
